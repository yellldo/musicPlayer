...
/**
 * ClassName : GlobalResponseBodyHandler<br>
 * Description : 全局响应结果（ResponseBody）处理器<br>
 * 不同于在网上看到的很多文章，会选择自动将 Controller 返回结果包上 {@link com.music.player.framework.common.domain.CommonResult}，
 * 在 onemall 中，是 Controller 在返回时，主动自己包上 {@link com.music.player.framework.common.domain.CommonResult}。
