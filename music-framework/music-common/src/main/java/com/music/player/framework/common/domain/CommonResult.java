...
public class CommonResult<T> implements Serializable {
     ...
     * 错误码
     *
     * @see com.music.player.framework.common.exceptions.ErrorCode#getCode()
     */
     ...
     * 错误提示，用户可阅读
     *
     * @see com.music.player.framework.common.exceptions.ErrorCode#getMsg() ()
     */
    private String msg;
    ...
    /**
     * 判断是否有异常。如果有，则抛出 {@link com.music.player.framework.common.exceptions.ServiceException} 异常
     */
