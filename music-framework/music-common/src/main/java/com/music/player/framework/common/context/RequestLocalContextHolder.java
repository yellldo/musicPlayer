package com.music.player.framework.common.context;
...
import com.music.player.framework.common.util.ListUtils;
...
/**
 * ClassName : RequestLocalContextHolder<br>
 * Description : 获取当前域中的 用户id, 用户昵称 注意： 用户id 和 用户昵称必须在前端 通过请求头的方法传入。 否则这里无法获取<br>
 *
 * @author : sj
 * @date : 2024/5/1
 */
