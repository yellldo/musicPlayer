...
import com.music.player.framework.common.util.DateUtils;
import com.music.player.framework.mybatis.base.lisenter.ImportDataListener;
import com.music.player.framework.mybatis.dto.DeleteDTO;
import com.music.player.framework.mybatis.dto.PageParams;
...
/**
 * ClassName : CurdController<br>
 * Description : curd 接口自动生成类<br>
 *
 * @author : sj
 * @date : 2024/5/5
 */
