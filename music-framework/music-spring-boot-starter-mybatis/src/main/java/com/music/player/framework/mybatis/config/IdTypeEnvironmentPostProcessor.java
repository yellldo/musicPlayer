...
import com.music.player.framework.common.utils.SetUtils;
import com.music.player.framework.mybatis.core.utils.JdbcUtils;
...
public class IdTypeEnvironmentPostProcessor implements EnvironmentPostProcessor {
    ...
    public void setJobStoreDriverIfPresent(ConfigurableEnvironment environment, DbType dbType) {
        ...
        switch (dbType) {
            ...
            case DM, KINGBASE_ES -> driverClass = "org.quartz.impl.jdbcjobstore.StdJDBCDelegate";
        }
        // 设置 driverClass 变量
        if (StrUtil.isNotEmpty(driverClass)) {
