...
import com.music.player.framework.common.json.JsonUtils;
import com.music.player.framework.common.util.StrPool;
import com.music.player.framework.mybatis.echo.EchoField;
import com.music.player.framework.mybatis.echo.manager.CacheLoadKeys;
import com.music.player.framework.mybatis.echo.manager.ClassManager;
import com.music.player.framework.mybatis.echo.manager.FieldParam;
import com.music.player.framework.mybatis.echo.manager.LoadKey;
 ...
 * Description : 字典数据回显工具类 1. 通过反射将obj的字段上标记了@Echo注解的字段解析出来 2. 依次查询待回显的数据 3. 将查询出来结果回显到obj的 @Echo注解的字段中<br>
 *
 * @author : sj
 * @date : 2024/5/5
 */
