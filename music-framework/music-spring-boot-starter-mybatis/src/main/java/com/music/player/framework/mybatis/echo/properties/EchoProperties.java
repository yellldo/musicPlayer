package com.music.player.framework.mybatis.echo.properties;
...
import static com.music.player.framework.mybatis.echo.properties.EchoProperties.DATA_ECHO_PREFIX;

/**
 * ClassName : EchoProperties<br>
 * Description : 回显配置类
 * <p>
 * 必须重写该类的 equals() 和 hashCode() 便于Map操作<br>
 *
 * @author : sj
 * @date : 2024/5/5
 */
