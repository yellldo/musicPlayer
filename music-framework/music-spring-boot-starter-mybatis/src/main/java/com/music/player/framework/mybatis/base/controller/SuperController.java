...
/**
 * ClassName : SuperController<br>
 * Description : SuperController<br>
 * 继承该类，就拥有了如下方法： 1，page 分页查询，并支持子类扩展4个方法：
 * 1.handlerQueryParams、query、handlerWrapper、handlerResult
 ...
 * 8.export导出，并支持子类扩展3个方法：handlerQueryParams、query、handlerResult
 * 9.preview导出预览，并支持子类扩展3个方法：handlerQueryParams、query、handlerResult
 * <p>
 ...
 * @date : 2024/5/5
 */
public abstract class SuperController<S extends SuperService<Entity>, Id extends Serializable, Entity, SaveDTO, UpdateDTO, QueryDTO, ExcelEntity>
