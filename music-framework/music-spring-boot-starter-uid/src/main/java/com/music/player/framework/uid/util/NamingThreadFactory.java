...
/**
 * ClassName : NamingThreadFactory<br>
 * Description : Named thread in ThreadFactory. If there is no specified name for thread, it will auto detect using the invoker classname instead.<br>
 *
 * @author : sj
 * @date : 2024/5/1
 */
