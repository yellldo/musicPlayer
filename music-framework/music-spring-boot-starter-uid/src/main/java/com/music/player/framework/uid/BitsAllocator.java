...
/**
 * ClassName : BitsAllocator<br>
 * Description : 对SnowFlake 的ID进行位操作的共聚类
 * <p>
 * 为UID分配64位(long)<br> sign (fixed 1bit) -> deltaSecond -> workerId -> sequence(within the same second)<br>
 *
 * @author : sj
 * @date : 2024/5/1
 */
