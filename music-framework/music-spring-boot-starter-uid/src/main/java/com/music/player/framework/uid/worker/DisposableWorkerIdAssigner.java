...
import com.music.player.framework.uid.util.DockerUtils;
import com.music.player.framework.uid.util.NetUtils;
import com.music.player.framework.uid.worker.entity.WorkerNodeEntity;
 ...
 * Description : Represents an implementation of {@link WorkerIdAssigner}, the worker id will be discarded after assigned to the UidGenerator<br>
 * <p>
