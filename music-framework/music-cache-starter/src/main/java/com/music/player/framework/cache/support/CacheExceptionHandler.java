package com.music.player.framework.cache.support;
...
/**
 * ClassName : CacheExceptionHandler<br>
 * Description : CacheExceptionHandler<br>
 *
 * @author : sj
 * @date : 2024/8/29
 */
...
public class CacheExceptionHandler implements Ordered {
    ...
    public R<?> handleClusterRedirectException(ClusterRedirectException e) {
        ...
        return R.failed(ResultErrorCode.CLUSTER_REDIRECT_EXCEPTION.getErrorCode(),
    ...
    public R<?> handleJedisException(JedisException e) {
        ...
        return R.failed(ResultErrorCode.FAILURE.getErrorCode(), e.getMessage());
    }
