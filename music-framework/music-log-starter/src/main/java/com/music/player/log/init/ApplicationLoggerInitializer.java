package com.music.player.log.init;
...
/**
 * ClassName : ApplicationLoggerInitializer<br>
 * Description : 通过环境变量的形式注入 logging.file 自动维护 Spring Boot Admin Logger Viewer<br>
 *
 * @author : sj
 * @date : 2024/5/16
 */
